# `feedme` from DEFCON Quals 2016

`feedme` is an excellent challenge from the [2016 DEFCON Quals][quals-2016].
...
[binary]: feedme
[docker-container]: https://hub.docker.com/r/adamdoupe/feedme/
